...
import motorpoolBusImage from "../sidebaraddbooking/images/Motorpool-bus.jpg";

function Logoutaddbook() {
  ...
  return (
    <div>
      <div
        className="logouts Logoutheaders"
