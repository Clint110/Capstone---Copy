  ...
  const handleGoogleLoginSuccess = async (tokenResponse) => {
    ...
    try {
      const decodedToken = JSON.parse(
        atob(tokenResponse.credential.split(".")[1])
      );
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="form-title text-center">
                ...
                <p>
                  Access your account securely by logging in with your
                  credentials
                </p>
                {errorMessage && (
...
Login</button>  
        ...
        <div className="content">
          <h1>
            University Vehicle <br /> Tracking &amp; Monitoring{" "}
          </h1>
          <p>
            Stay on track with our university vehicle tracking and monitoring
            system! <br /> Ensure safety, efficiency, and accountability for all
            campus vehicles.
          </p>
          <a data-toggle="modal" data-target="#loginModal" className="btn">
            Login
          </a>
        </div>
      </div>
